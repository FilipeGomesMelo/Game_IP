# Nota: 
  O código original entregue durante a cadeira em 2020.3 se encontra no branch Original, o ramo main possui algumas mudanças de animações e colisão e movimento dos inimigos.
...
#
###### *Projeto referente a matéria de Introdução a programação/CIN-UFPE no periodo de 2020.3*
